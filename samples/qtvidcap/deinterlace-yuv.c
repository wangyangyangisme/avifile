/* $Id: deinterlace-yuv.c,v 1.3 2003/05/19 07:53:37 kabi Exp $ */
			      ...
			      int width, int height )
{
  ...
  const unsigned long long Mask = (unsigned long long)(0xfefefefefefefefeLL);
  const unsigned long long YMask = (unsigned long long)(0x00ff00ff00ff00ffLL);
  ...
  emms();
#else
#warning missing deinterlace_bob_yuv_mmx
#endif
}
